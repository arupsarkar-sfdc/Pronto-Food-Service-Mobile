...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithTransformers:(NSArray<SFPTransformer *> * _Nonnull)transformers experiences:(NSArray<SFPersonalizationExperienceConfig *> * _Nonnull)experiences OBJC_DESIGNATED_INITIALIZER;
@end
