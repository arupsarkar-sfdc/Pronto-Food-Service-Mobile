...
@class SFPEngagementSubDefValue;
/// Defines how to construct engagement events for personalizations.
/// Obtained from CDN via <code>ServerP13nAppConfig/engagementEvents</code>.
/// Each definition either targets specific Personalization Points (via <code>dataProviders</code>) or is
/// the <code>isDefault</code> fallback used when no specific definition matches.
SWIFT_CLASS_NAMED("EngagementEventDefinition")
@interface SFPEngagementEventDefinition : NSObject
/// <code>true</code> when this definition is not associated with any Personalization Point/Schema and
/// is to be used as the fallback whenever no other definition matches the active
/// Personalization Experience Config.
@property (nonatomic, readonly) BOOL isDefault;
/// All <code>DataProvider</code>s this definition applies to. Empty when <code>isDefault</code> is <code>true</code>.
@property (nonatomic, readonly, copy) NSArray<SFPDataProvider *> * _Nonnull dataProviders;
/// Map of action name (e.g. <code>"View"</code>) to action value (e.g. <code>"personalization-view"</code>).
/// Components support standard actions <code>"View"</code>, <code>"Click"</code>, and <code>"Dismiss"</code>. Customers
/// may add additional custom actions for their own components.
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull actions;
/// Map of event field name (e.g. <code>"eventType"</code>, <code>"campaignName"</code>) to its substitution
/// definition. The field’s value is derived per the <code>EngagementSubDefValue/configType</code>.
@property (nonatomic, readonly, copy) NSDictionary<NSString *, SFPEngagementSubDefValue *> * _Nonnull fields;
- (nonnull instancetype)initWithIsDefault:(BOOL)isDefault dataProviders:(NSArray<SFPDataProvider *> * _Nonnull)dataProviders actions:(NSDictionary<NSString *, NSString *> * _Nonnull)actions fields:(NSDictionary<NSString *, SFPEngagementSubDefValue *> * _Nonnull)fields OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Defines how to populate an engagement event field value.
/// Used by <code>EngagementSubDefValue/configType</code> and <code>EngagementEventDefinition/fields</code>.
/// Note: this is intentionally <em>not</em> a superset of <code>SubDefConfigType</code> because Swift enums
/// cannot extend other enums and the additional <code>action</code> case applies only to engagement
/// event definitions (never to content transformer substitutions).
typedef SWIFT_ENUM_NAMED(NSInteger, SFPEngagementSubDefConfigType, "EngagementSubDefConfigType", open) {
/// The associated <code>EngagementSubDefValue/value</code> is a path into the
/// <code>DecisionsResponsePersonalization</code> at runtime — for example
/// <code>attributes.SomeHeader</code> or <code>data.*.SomeTitle</code>.
  SFPEngagementSubDefConfigTypeSchemaPath = 0,
/// The associated <code>EngagementSubDefValue/value</code> is the literal string to use as the field
/// value.
  SFPEngagementSubDefConfigTypeStaticValue = 1,
/// The field value comes from <code>EngagementEventDefinition/actions</code> for the current action
/// being evaluated. For example, given <code>actions = ["View": "personalization-view"]</code>, when
/// constructing the “View” event the field value is <code>"personalization-view"</code>.
/// This case is exclusive to <code>EngagementEventDefinition/fields</code>.
  SFPEngagementSubDefConfigTypeAction = 2,
};

/// Defines how a single engagement event field value should be derived.
/// See <code>EngagementEventDefinition/fields</code>.
SWIFT_CLASS_NAMED("EngagementSubDefValue")
@interface SFPEngagementSubDefValue : NSObject
/// Path or literal value, depending on <code>configType</code>. Not needed when <code>configType</code> is
/// <code>EngagementSubDefConfigType/action</code>.
@property (nonatomic, readonly, copy) NSString * _Nonnull value;
/// How to obtain the field value. See <code>EngagementSubDefConfigType</code>.
@property (nonatomic, readonly) enum SFPEngagementSubDefConfigType configType;
- (nonnull instancetype)initWithValue:(NSString * _Nonnull)value configType:(enum SFPEngagementSubDefConfigType)configType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_ENUM_FWD_DECL(NSInteger, SFMCSdkModuleName)
...
@class SFPTransformer;
SWIFT_CLASS_NAMED("ServerP13nAppConfig")
@interface SFPServerP13nAppConfig : NSObject
@property (nonatomic, readonly, copy) NSArray<SFPTransformer *> * _Nonnull transformers;
@property (nonatomic, readonly, copy) NSArray<SFPersonalizationExperienceConfig *> * _Nonnull experiences;
/// Engagement event definitions delivered by the CDN. Validated and filtered by
/// <code>ServerAppConfigManager.prepareConfig</code>. Used by <code>EngagementTransformer</code> to build
/// the <code>EngagementPayloads</code> delivered to a <code>Component</code> via <code>ComponentContext</code>.
@property (nonatomic, readonly, copy) NSArray<SFPEngagementEventDefinition *> * _Nonnull engagementEvents;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithTransformers:(NSArray<SFPTransformer *> * _Nonnull)transformers experiences:(NSArray<SFPersonalizationExperienceConfig *> * _Nonnull)experiences engagementEvents:(NSArray<SFPEngagementEventDefinition *> * _Nonnull)engagementEvents OBJC_DESIGNATED_INITIALIZER;
@end
...
@class SFPTransTypeDetails;
@class SFPTransformerSubDef;
/// A Personalization Transformer (aka Personalization Template) describes how data can be transformed into other content. It is meant to live independently of a Personalization Experience Config and can be reused across Personalization Experience Configs.
SWIFT_CLASS_NAMED("Transformer")
@interface SFPTransformer : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
@property (nonatomic, readonly, copy) NSDate * _Nonnull lastModifiedDate;
@property (nonatomic, readonly, strong) SFPTransTypeDetails * _Nullable transformerTypeDetails;
@property (nonatomic, readonly, copy) NSString * _Nullable schemaReference;
@property (nonatomic, copy) NSDate * _Nullable publishedDate;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, SFPTransformerSubDef *> * _Nonnull substitutionDefinitions;
@property (nonatomic, readonly) BOOL isEnabled;
- (nonnull instancetype)initWithName:(NSString * _Nonnull)name schemaReference:(NSString * _Nullable)schemaReference transformerTypeDetails:(SFPTransTypeDetails * _Nullable)transformerTypeDetails substitutionDefinitions:(NSDictionary<NSString *, SFPTransformerSubDef *> * _Nonnull)substitutionDefinitions isEnabled:(BOOL)isEnabled publishedDate:(NSDate * _Nullable)publishedDate lastModifiedDate:(NSDate * _Nonnull)lastModifiedDate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
